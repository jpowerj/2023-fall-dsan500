...
In the <a href='../clustering/' targetr='_blank'>writeup on clustering</a> we used Plotly to create visualizations of which observations had been placed into which clusters, and in the <a href='../decision-trees/' target='_blank'>writeup on decision Trees</a> we again used Plotly to visualize how decision trees work to "chop" the feature space into optimal subregions ("optimal" in the sense of reducing uncertainty!).
